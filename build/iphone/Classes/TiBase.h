...
// in simulator we redefine to format for AppconomySDKExampleApp Developer console
...
{\
	NSString * exceptionName = [@"org.appconomysdkexampleapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.appconomysdkexampleapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIAppconomySDKExampleAppNativeItemNone = -1, 
	UIAppconomySDKExampleAppNativeItemSpinner = -2,
	UIAppconomySDKExampleAppNativeItemProgressBar = -3,
	
	UIAppconomySDKExampleAppNativeItemSlider = -4,
	UIAppconomySDKExampleAppNativeItemSwitch = -5,
	UIAppconomySDKExampleAppNativeItemMultiButton = -6,
	UIAppconomySDKExampleAppNativeItemSegmented = -7,
	
	UIAppconomySDKExampleAppNativeItemTextView = -8,
	UIAppconomySDKExampleAppNativeItemTextField = -9,
	UIAppconomySDKExampleAppNativeItemSearchBar = -10,
	
	UIAppconomySDKExampleAppNativeItemPicker = -11,
	UIAppconomySDKExampleAppNativeItemDatePicker = -12,
	
	UIAppconomySDKExampleAppNativeItemInfoLight = -13,
	UIAppconomySDKExampleAppNativeItemInfoDark = -14,
	
	UIAppconomySDKExampleAppNativeItemDisclosure = -15,
	
	UIAppconomySDKExampleAppNativeItemContactAdd = -16
};

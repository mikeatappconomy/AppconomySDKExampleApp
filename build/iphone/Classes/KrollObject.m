...
//@interface AppconomySDKExampleAppObject : NSObject
//@end

@interface AppconomySDKExampleAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AppconomySDKExampleAppObject class]])
		{
			for (NSString *key in [[(AppconomySDKExampleAppObject*)o modules] allKeys])
			{

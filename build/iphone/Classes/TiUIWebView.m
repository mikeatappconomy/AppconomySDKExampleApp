...
static NSString * const kAppconomySDKExampleAppJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_appconomysdkexampleappInjection
{
	...
	[html appendString:kAppconomySDKExampleAppJavascript];
...
{
	// attempt to make well-formed HTML and inject in our AppconomySDKExampleApp bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _appconomysdkexampleappInjection]];
	...
	else
	{
		...
		if ([[NSFileManager defaultManager] fileExistsAtPath:path])
		{
			...
			else
			{
				...
				{
					NSLog(@"[WARN] I have no idea what the appropriate text encoding is for: %@. Please report this to AppconomySDKExampleApp support.",url);
				}
			}
